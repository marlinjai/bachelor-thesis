...
% Web Technology Entries
\newglossaryentry{HTML}{
    name=HTML (HyperText Markup Language),
    description={The standard markup language used to create web pages and web applications, defining the structure and content of web documents}
}

\newglossaryentry{CSS}{
    name=CSS (Cascading Style Sheets),
    description={A style sheet language used for describing the presentation of a document written in HTML or XML, including layout, colors, and fonts}
}

\newglossaryentry{VDOM}{
    name=VDOM (Virtual DOM),
    description={A programming concept where a virtual representation of the DOM is kept in memory and synced with the real DOM through a process called reconciliation}
}
...
\newglossaryentry{LCDP}{
    name=LCDP (Low-Code Development Platforms),
    description={A software development platform that enables rapid application development with minimal hand-coding through visual interfaces, drag-and-drop components, and model-driven approaches}
}

\newglossaryentry{DOM}{
    name=DOM (Document Object Model),
    description={A programming interface for HTML and XML documents, representing the structure of a document as a tree of nodes}
}

\newglossaryentry{Babel}{
    name=Babel,
    description={A JavaScript transpiler that transforms JavaScript code into a more compatible version for the target environment}
}

\newglossaryentry{Vibe Coding}{
    name=Vibe Coding,
    description={An AI-assisted style of programming, popularized by Andrej Karpathy, where developers describe their intent in natural language and let an AI model generate and iterate on the code. Instead of manually writing implementation details, programmers “go with the flow” by guiding, testing, and refining outputs interactively.}
}

\newglossaryentry{Reactive Programming}{
    name=Reactive Programming,
    description={A programming paradigm that allows developers to create applications that react to changes in data}
}