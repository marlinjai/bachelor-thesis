...
\newglossaryentry{staticweb}{
    name=Static Web Output,
    description={Traditional web content consisting of HTML, CSS, and JavaScript files that are pre-built and served as-is, without dynamic server-side processing}
}
